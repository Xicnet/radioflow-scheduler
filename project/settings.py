...
DATABASES = {
    'default': {
        ...
        'NAME': 'timeslot.sql',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = '7feip_1u5i^gmah%%cp3e=v8u+nsmxu5@x^hc%j1ps0@qg(_r2'
...
try:
    ...
    print "Cannot import local_settings. EXCEPTION: %s" % str(e)
    pass
