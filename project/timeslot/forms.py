...
class ConfigForm(forms.Form):
    ...
    logo       = forms.ImageField(label="Logo (sin alpha)*", required=False, help_text="2048x2048 PNG 32-bit SIN alpha. Se utiliza en las tiendas de apps y en la pantalla principal de la app.")
    logo_alpha = forms.ImageField(label="Logo (con alpha)*", required=False, help_text="2048x2048 PNG 32-bit CON alpha. Se utiliza en las tiendas de apps y en la pantalla principal de la app.")
