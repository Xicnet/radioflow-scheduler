...
class ConfigForm(forms.Form):
    ...
    logo       = forms.ImageField(label="Logo*", required=False, help_text="2048x2048 PNG 32-bit con alpha. Se utiliza en las tiendas de apps y en la pantalla principal de la app.")
