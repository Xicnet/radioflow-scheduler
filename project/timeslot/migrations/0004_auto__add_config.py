...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Config'
        db.create_table('timeslot_config', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('streamurl', self.gf('django.db.models.fields.CharField')(max_length=512)),
            ('image', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True)),
            ('cropping', self.gf(u'django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ))
        db.send_create_signal('timeslot', ['Config'])


    def backwards(self, orm):
        # Deleting model 'Config'
        db.delete_table('timeslot_config')
    ...
    models = {
        ...
        'timeslot.config': {
            ...
            'streamurl': ('django.db.models.fields.CharField', [], {'max_length': '512'}),
